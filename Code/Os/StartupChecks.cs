...
namespace Flowframes.Os
{
    class StartupChecks
    {
        static bool IsWin10Or11()
        {
            ...
            return version.Contains("windows 10", System.StringComparison.InvariantCultureIgnoreCase) || version.Contains("windows 11", System.StringComparison.InvariantCultureIgnoreCase);
        }
        ...
        {
            if (!File.Exists(Paths.GetVerPath()) && Paths.GetExeDir().Contains("temp", System.StringComparison.InvariantCultureIgnoreCase))
            {
            ...
            if (!version.Contains("windows 10", System.StringComparison.InvariantCultureIgnoreCase) && !version.Contains("windows 11", System.StringComparison.InvariantCultureIgnoreCase) && !Config.GetBool("ignoreIncompatibleOs", false))
            {
